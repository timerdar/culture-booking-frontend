        ...
        <div className={styles.container}>
            ...
            {events.map((event) => (
                <li className={styles.eventItem} key={event.id}>
                    ...
                    <button className={styles.registerButton} onClick={() => {navigate(`/admin/${event.id}/tickets/`)}}>Открыть список билетов</button>
                    <button className={styles.registerButton} onClick={() => {navigate(`/admin/${event.id}/seatsControl/`)}}>Посмотреть на карту рассадки</button>
